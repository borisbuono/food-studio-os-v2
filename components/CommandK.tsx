...
const ROUTES: { label: string; href: string }[] = [
  ...
  { label: "Schedule", href: "/schedule" }, { label: "Finance", href: "/administrate/finance" }, { label: "Cash flow", href: "/administrate/cashflow" },
  { label: "Missing invoices", href: "/administrate/invoices" }, { label: "EOD reports", href: "/administrate/finance/eod" },
  { label: "Events", href: "/administrate/events" }, { label: "Suppliers", href: "/administrate/suppliers" }, { label: "Place an order", href: "/order" },
