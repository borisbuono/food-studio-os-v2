...
export default async function Events() {
  ...
  return (
    <main className="mx-auto max-w-xl px-6 py-12">
      ...
      <Link href="/administrate/events/new" className="mt-4 inline-block rounded-xl bg-ochre px-5 py-3 font-sans text-[14px] font-medium text-[#F7F7F4]">+ New event</Link>
