...
export default async function Suppliers() {
  ...
  return (
    <main className="mx-auto max-w-xl lg:max-w-4xl px-6 py-12">
      ...
      <Link href="/execute/orders?tab=picker" className="mt-4 inline-block font-mono text-[11px] uppercase tracking-wide text-ink-soft">Find a product across all suppliers →</Link>
