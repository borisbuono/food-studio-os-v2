  ...
  return (
    <main className="mx-auto max-w-3xl lg:max-w-5xl px-6 py-12">
      ...
      <div className="mt-6 flex items-baseline justify-between gap-4">
        ...
        <Link href="/grow/commercials?new=1" className="rounded-xl px-4 py-2.5 font-sans text-[13px] font-medium text-[#F7F7F4]" style={{ background: "var(--accent)" }}>+ New commercial</Link>
      </div>
      ...
      {!loaded ? (
        ...
        <section className="mt-10 border-t border-line pt-6">
          ...
          <Link href="/grow/commercials?new=1" className="mt-3 inline-block font-mono text-[11px] uppercase tracking-wide" style={{ color: "var(--accent)" }}>Start →</Link>
        </section>
      ) : (
        <>
