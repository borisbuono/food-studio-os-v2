...
export default function GrowRelationships() {
  ...
  return (
    <main className="mx-auto max-w-3xl lg:max-w-5xl px-6 py-12">
      <Link href="/execute/bookings" className="font-sans text-sm text-ink-soft">← service</Link>
      <div className="mt-6 flex items-baseline justify-between gap-4">
        ...
        <Link href="/grow/relationships?new=1" className="rounded-xl px-4 py-2.5 font-sans text-[13px] font-medium text-[#F7F7F4]" style={{ background: "var(--accent)" }}>+ Add guest</Link>
      </div>
