...
export default async function Command() {
  ...
  return (
    <main className="mx-auto max-w-xl px-6 py-12">
      ...
      <p className="mt-6 font-sans text-xs font-medium text-ember">Command center</p>
      <h1 className="mt-2 font-serif text-3xl text-ink">The control room</h1>

      <div className="mt-6 grid grid-cols-3 gap-3">
        {tiles.map((t) => (
          <Link key={t.href} href={t.href} className="rounded-2xl border border-black/10 bg-card p-4 text-center transition hover:border-ember/40">
