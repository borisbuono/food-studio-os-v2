...
// The order builder — was app/execute/orders/page.tsx; page.tsx now wraps it
// with Receiving and Picker as tabs (slim OS slice 3).
export default function Order() {
  ...
  if (loading) return <main className="mx-auto max-w-xl lg:max-w-4xl px-6 py-6"><p className="font-serif text-2xl text-ink">Loading suppliers…</p></main>;
