...
export default async function Today() {
  ...
  return (
    <main className="mx-auto max-w-xl px-6 py-12">
      ...
      <p className="mt-6 font-sans text-xs font-medium text-basil">Today · {venue?.name}</p>
      ...
      <div className="mt-8 rounded-2xl border border-black/10 bg-card p-6">
        <p className="font-sans text-xs font-medium text-basil">Covers today</p>
      ...
      <div className="mt-4 rounded-2xl border border-black/10 bg-card p-6">
        <p className="font-sans text-xs font-medium text-basil">Priority prep</p>
        {preps.length ? (
        ...
        <Link href="/execute/prep" className="mt-4 inline-block font-sans text-sm text-basil">All prep →</Link>
      </div>

      <Link href="/execute/cleaning" className="mt-4 block rounded-2xl border border-black/10 bg-card p-6 transition hover:border-basil/40">
        <p className="font-sans text-xs font-medium text-basil">Cleaning due today</p>
