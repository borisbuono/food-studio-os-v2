...
export default function Handover() {
  ...
  return (
    <main className="mx-auto max-w-xl px-6 py-12">
      ...
      <p className="mt-6 font-sans text-xs font-medium text-basil">Handover · pass-down</p>
      ...
      <textarea
        ...
        className="mt-6 h-64 w-full rounded-2xl border border-black/15 bg-card p-4 font-serif text-[16px] leading-relaxed text-ink outline-none focus:border-basil"
      />
