...
// Pillar-scoped alias — the canonical route lives at /administrate/agent-charters. This tiny
...
export default function Page() { redirect("/administrate/agent-charters"); }
