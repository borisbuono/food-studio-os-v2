...
// Pillar-scoped alias — the canonical route lives at /administrate/holdings/console. This tiny
...
export default function Page() { redirect("/administrate/holdings/console"); }
