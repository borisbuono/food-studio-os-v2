...
//
// P0 fix 2026-09-21 (Utopia unblock, Boris walk 01:05 CET). Utopia was
// resurrected as the sandbox / demo venue (entity_id
// f365f49d-4cd1-43d1-955f-03c21816ad22, restaurant_id
// a0000000-0000-4000-8000-000000000001, slug 'utopia'). It is now a fourth
// pinned entity so the fs_entity cookie survives round-trips, ENTITY_LABEL
// / ENTITY_ACCENT lookups return real values (undefined broke recipe list
// paint), and Chef's route-context resolver recognises it. Long-term the
// static maps should die entirely (audit 09-21); this interim ships tonight.
...
export const E_UTOPIA   = "f365f49d-4cd1-43d1-955f-03c21816ad22" as const;
...
export const ENTITY_ORDER: EntityKey[] = [E_HOLDINGS, E_BM, E_TALLER, E_UTOPIA];

// True when the value is one of the pinned primary entities. Guards
...
export function isPrimaryEntity(x: string | null | undefined): x is EntityKey {
  return x === E_HOLDINGS || x === E_BM || x === E_TALLER || x === E_UTOPIA;
}
...
export function publicNameForEntity(entity: EntityKey | string | null | undefined): string {
  ...
  if (e === "utopia" || e === "utopia kitchen b.v." || e === "utopia kitchen bv") return "Utopia";
...
export const ENTITY_WORDMARK: Record<EntityKey, string> = {
  ...
  [E_UTOPIA]:   "font-serif text-[17px] tracking-tight text-ink",
};
...
export const ENTITY_H1: Record<EntityKey, string> = {
  ...
  [E_UTOPIA]:   "font-serif text-3xl text-ink",
};
...
export const ENTITY_ACCENT: Record<EntityKey, string> = {
  ...
  [E_UTOPIA]:   "#8B6F47",      // warm sand — sandbox (mirrors entities.accent_color)
};
...
// Utopia was seeded 2026-09-21 as the sandbox venue and reuses the historical
// trial restaurant UUID (a0000000-…-0001, renamed + relinked in that pass).
export const RESTAURANT_TO_ENTITY: Record<string, EntityKey> = {
  ...
  "a0000000-0000-4000-8000-000000000001": E_UTOPIA,
};
export const ENTITY_TO_RESTAURANT: Partial<Record<EntityKey, string>> = {
  ...
  [E_UTOPIA]: "a0000000-0000-4000-8000-000000000001",
};
